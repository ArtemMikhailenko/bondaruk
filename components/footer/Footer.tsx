...
export function Footer() {
  ...
  return (
    <footer className="relative bg-[#1D1918] text-white min-h-[906px] md:min-h-[489px] py-10 md:py-8 2xl:py-0 2xl:h-[489px]">
      <div className="max-w-[1920px] mx-auto h-full px-4 lg:px-8 2xl:px-0">
        {/* Social buttons */}
        <div className="2xl:absolute 2xl:top-5 2xl:left-[232px] 2xl:right-[232px] grid grid-cols-2 md:flex gap-3 2xl:gap-[14px] md:justify-between mb-8 2xl:mb-0">
          <a href="#" className="group flex items-center justify-center gap-2 lg:gap-3 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[65px] md:rounded-[49px] px-10 md:px-6 lg:px-8 xl:px-12 2xl:px-[120px] py-[18px] md:py-[18px] h-[52px] md:h-[61px] transition-all md:flex-1 2xl:flex-initial">
            <svg width="14" height="14" viewBox="0 0 18 15" fill="none" className="fill-[#1D1918] group-hover:fill-white transition-all md:w-[18px] md:h-[15px]">
            ...
            <span className="text-[13px] md:text-sm lg:text-base 2xl:text-lg leading-[13px] md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Telegram</span>
          </a>

          <a href="#" className="group flex items-center justify-center gap-2 lg:gap-3 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[65px] md:rounded-[49px] px-10 md:px-6 lg:px-8 xl:px-12 2xl:px-[120px] py-[18px] md:py-[18px] h-[52px] md:h-[61px] transition-all md:flex-1 2xl:flex-initial">
            <Image src="/icons/viber.svg" alt="Viber" width={18} height={19} className="w-[18px] h-[19px] group-hover:brightness-0 group-hover:invert transition-all" />
            <span className="text-[13px] md:text-sm lg:text-base 2xl:text-lg leading-[13px] md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Viber</span>
          </a>

          <a href="#" className="group flex items-center justify-center gap-2 lg:gap-3 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[65px] md:rounded-[49px] px-10 md:px-6 lg:px-8 xl:px-12 2xl:px-[120px] py-[18px] md:py-[18px] h-[52px] md:h-[61px] transition-all md:flex-1 2xl:flex-initial">
            <svg width="17" height="17" viewBox="0 0 20 20" fill="none" className="fill-[#1D1918] group-hover:fill-white transition-all md:w-[20px] md:h-[20px]">
            ...
            <span className="text-[13px] md:text-sm lg:text-base 2xl:text-lg leading-[13px] md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Instagram</span>
          </a>

          <a href="#" className="group flex items-center justify-center gap-2 lg:gap-3 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[65px] md:rounded-[49px] px-10 md:px-6 lg:px-8 xl:px-12 2xl:px-[120px] py-[18px] md:py-[18px] h-[52px] md:h-[61px] transition-all md:flex-1 2xl:flex-initial">
            <svg width="8" height="15" viewBox="0 0 11 19" fill="none" className="fill-[#1D1918] group-hover:fill-white transition-all md:w-[11px] md:h-[19px]">
              <path d="M6.5 6V4C6.5 3.44772 6.94772 3 7.5 3H8.5V0H6.5C4.84315 0 3.5 1.34315 3.5 3V6H0.5V9H3.5V18H6.5V9H8.5L9.5 6H6.5Z"/>
            </svg>
            <span className="text-[13px] md:text-sm lg:text-base 2xl:text-lg leading-[13px] md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Facebook</span>
          </a>
        </div>

        {/* Top border */}
        <div className="2xl:absolute 2xl:top-[102px] left-0 w-full h-px bg-white/5 my-8 md:my-8 2xl:my-0 rounded-[29px]" />

        {/* Content grid */}
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-8 2xl:gap-0">
          {/* Logo and CTA */}
          <div className="2xl:absolute 2xl:top-[126px] 2xl:left-[240px]">
            <Image 
            ...
            <a href="#" className="mt-[33px] md:mt-[33px] flex items-center gap-5 w-full max-w-[298px] md:max-w-[371px] h-[52px] md:h-[62px] bg-gradient-to-b from-[#FFCF2B] to-[#F7B91E] rounded-[55px] px-2 py-2 hover:opacity-90 transition-opacity">
              <div className="w-[36px] h-[36px] md:w-[46px] md:h-[46px] bg-[#1D1918] rounded-full flex items-center justify-center">
                <svg width="19" height="19" viewBox="0 0 24 24" fill="none" className="ml-1.5 md:ml-2.5 md:w-[24px] md:h-[24px]">
                  <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <span className="text-[14px] md:text-base leading-6 font-bold text-[#1D1918]">{t.footer.cta}</span>
            </a>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 md:contents">
            {/* Services Menu */}
            <div className="2xl:absolute 2xl:top-[144px] 2xl:left-[882px]">
              <p className="text-[14px] md:text-base leading-[14px] md:leading-[25px] text-[#979797] mb-[28px] md:mb-[28px]">{t.footer.servicesTitle}</p>
              <nav className="flex flex-col gap-[14px] md:gap-[21px]">
            ...
            {/* Navigation Menu */}
            <div className="2xl:absolute 2xl:top-[144px] 2xl:left-[1157px]">
              <p className="text-[14px] md:text-base leading-[14px] md:leading-[25px] text-[#979797] mb-[28px] md:mb-[28px]">{t.footer.navigationTitle}</p>
              <nav className="flex flex-col gap-[14px] md:gap-[21px]">
          ...
          {/* Contacts */}
          <div className="2xl:absolute 2xl:top-[144px] 2xl:left-[1433px]">
            <p className="text-[14px] md:text-base leading-[14px] md:leading-[25px] text-[#727272] mb-[28px] md:mb-[28px]">{t.footer.contactsTitle}</p>
        ...
        {/* Bottom border */}
        <div className="2xl:absolute 2xl:bottom-[71px] left-0 w-full h-px bg-white/5 my-8 md:my-8 2xl:my-0 rounded-[29px]" />

        {/* Bottom links */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 2xl:absolute 2xl:bottom-[30px] 2xl:left-[240px] 2xl:right-[240px]">
