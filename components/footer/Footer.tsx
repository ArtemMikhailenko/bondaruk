    ...
    <footer className="relative bg-[#1D1918] text-white min-h-[906px] md:min-h-[489px] py-10 md:py-8 2xl:py-0 2xl:h-[489px]">
      <div className="max-w-[1920px] mx-auto h-full px-4 lg:px-8 2xl:px-0">
        ...
        <div className="2xl:absolute 2xl:top-5 2xl:left-[232px] 2xl:right-[232px] grid grid-cols-2 md:flex gap-3 2xl:gap-[14px] md:justify-between mb-8 2xl:mb-0">
          <a href="#" className="group flex items-center justify-center gap-3 lg:gap-4 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[999px] px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-[120px] h-[60px] md:h-[72px] transition-all md:flex-1 2xl:flex-initial">
          ...
          <a href="#" className="group flex items-center justify-center gap-3 lg:gap-4 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[999px] px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-[120px] h-[60px] md:h-[72px] transition-all md:flex-1 2xl:flex-initial">
            ...
            <span className="text-[14px] md:text-base 2xl:text-lg leading-none md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Viber</span>
          </a>
          ...
          <a href="#" className="group flex items-center justify-center gap-3 lg:gap-4 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[999px] px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-[120px] h-[60px] md:h-[72px] transition-all md:flex-1 2xl:flex-initial">
            ...
            <span className="text-[14px] md:text-base 2xl:text-lg leading-none md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Instagram</span>
          </a>
          ...
          <a href="#" className="group flex items-center justify-center gap-3 lg:gap-4 bg-[#EFF8F3] hover:bg-gradient-to-b hover:from-[#31AA5A] hover:to-[#258A49] rounded-[999px] px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-[120px] h-[60px] md:h-[72px] transition-all md:flex-1 2xl:flex-initial">
            ...
            <span className="text-[14px] md:text-base 2xl:text-lg leading-none md:leading-[25px] font-semibold text-[#1D1918] group-hover:text-white whitespace-nowrap transition-all">Facebook</span>
          </a>
        </div>
